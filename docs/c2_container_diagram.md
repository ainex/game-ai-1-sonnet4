```mermaid
C4Container
    title Container diagram for Sims 4 AI Gaming Assistant

    Person(user, "Sims 4 Player", "Uses the assistant via hotkey.")
    System_Ext(sims4, "The Sims 4 Game", "Primary display for screenshots.")
    System_Ext(local_llm, "Local LLM (Future)", "Commercial LLM on Windows 11 for analysis.")

    System_Boundary(assistant_boundary, "Sims 4 AI Gaming Assistant") {
    ...
    Rel(client_app, sims4, "Captures Screenshot from", "OS API")
    ...
    UpdateRelStyle(client_app, sims4, $textColor="white", $lineColor="gray", $offsetY="10")
